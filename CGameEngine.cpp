...
bool CGameEngine::Init()
{
    ...
    if (!SDL_Init(SDL_INIT_VIDEO)) //Ce init va aussi initialiser le subSystem des Events
    {
    ...
    if (!SDL_CreateWindowAndRenderer(
        "Fenetre Boucle de Jeu", 
        800, // largeur
        600, // hauteur
        SDL_WINDOW_FULLSCREEN, // flags (définit le type de fenêtre eg. fullscreen, windowed, borderless...)
        &window, 
        &SDLRenderer)) // Création de la fenêtre et du renderer SDL
    {
